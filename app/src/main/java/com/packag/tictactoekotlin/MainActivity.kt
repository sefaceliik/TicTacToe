...
class MainActivity : AppCompatActivity() {
    ...
    private fun action(optionNumber: Int, _selectedImageButton: ImageButton ){
        ...
        if (playingPlayer == PLAYINGPLAYER.FIRST_PLAYER){
            selectedImageButton.setImageResource(R.drawable.redx)
        ...
        if (playingPlayer == PLAYINGPLAYER.SECOND_PLAYER){
            ...
            // selectedImageButton.setImageResource(R.drawable.oo)
    ...
    private fun resetGame() {
        ...
        imgButton1.setImageResource(R.mipmap.ic_launcher)
        imgButton2.setImageResource(R.mipmap.ic_launcher)
        imgButton3.setImageResource(R.mipmap.ic_launcher)
        imgButton4.setImageResource(R.mipmap.ic_launcher)
        imgButton5.setImageResource(R.mipmap.ic_launcher)
        imgButton6.setImageResource(R.mipmap.ic_launcher)
        imgButton7.setImageResource(R.mipmap.ic_launcher)
        imgButton8.setImageResource(R.mipmap.ic_launcher)
        imgButton9.setImageResource(R.mipmap.ic_launcher)
